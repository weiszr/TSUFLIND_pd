    ...
    with open(p_file_l, 'r') as f:
        for line in f:
            try:
                ...
                # model parameters
                if n == 'Dimensionless_shear_velovity':
                    Tstarcr = float(v)
...
# Take the result as these equation's parameters
    ...
    # get the critical shear stress and shear velocity
    def processdata1(tcr1, D, rhos1, rhos2, g):
        if tcr1 > 0.045:
            if tcr1 < 0.06:
            ...
            print("Please make dimensionless critical shear stress larger than0.045")
        return U1
    ...
    def processdata2(R, Vc, u1):  # get the particle settling velocity
        if R > 0.05:
            ...
            print("Please make Rouse number larger than 0.05")
        return ws
