...
# the phi scale
    ...
    if(setType == 1.0):
        # Settling velocity of each grain size
        ws = tubesetvel(se, Rhos, wtemp, sal)
    elif(setType == 2.0):
...
# This part is designed for calculate different grain size's thickness at still water level
    # The sediment load of different grain size sediments in still water level
    th = zeros(nc)
...
# will be used to calculate the percentage of different grain size
    ...
    # The sediment thickness in different sample location
    th2 = zeros(shape=(N, nc))
    # The area of sediment grain in different sample location
    A = zeros(shape=(N, nc))
    # The total area of sediment grain in different sample location
    sumA = zeros(N)
    # The total sediment thickness in different sample location
    totalth2 = zeros(N)
