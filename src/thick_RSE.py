...
def thcalrse(name, th2, N):
    # Average thickness difference between field data and model result for each sample location
    rse = zeros(N)
    ...
    if(n == m):
        ...
        print(
            "These Dimension of two document are not same, Please check the data structure")
    averthRSE = sum(rse)/N
    # print th1
    # print th2
    # print rse
